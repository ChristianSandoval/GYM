...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    public ProductsEditor(DataLogicSales dlSales, DirtyManager dirty, AppView app) {
        ...
        m_jDays.getDocument().addDocumentListener(dirty);
...
this.m_jCant1.getDocument().addDocumentListener(dirty);
    ...
    public void writeValueDelete(Object value) {
        ...
        m_jDays.setText(Formats.INT.formatValue(myprod[17]));
    ...
    public Object createValue() throws BasicException {
        ...
        myprod[17] = Formats.INT.parseValue(m_jDays.getText());
        /*String str = "";
    ...
    private void initComponents() {
        ...
        m_jDays = new javax.swing.JTextField();
        ...
        jLabel24.setBounds(10, 130, 150, 14);

        m_jDays.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel1.add(m_jDays);
        m_jDays.setBounds(160, 130, 80, 20);
...
this.prod14 = JProductFinder.showMessage(this, this.dlSales);
 ...
 this.prod20 = JProductFinder.showMessage(this, this.dlSales);
    ...
    private javax.swing.JTextField m_jDays;
